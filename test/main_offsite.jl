...
offsite_model.model(R12, offsite_model.ps, offsite_model.st)[1][3][1]
...
offsite_model = fit!(offsite_model, Rs, Ys; solver = ACEfit.QR())
...
@time E = abs.(eval_model(offsite_model, Rs[1]) - Ys[1]) |> norm
