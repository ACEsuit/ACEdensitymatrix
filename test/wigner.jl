# Codes hacked from ACE.jl - just to avoid the overhead of the package 
# ACE itself is in fact not needed in the current project, we just use this part of it to validate the equivariance of the data
